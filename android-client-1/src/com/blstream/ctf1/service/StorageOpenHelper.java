...
class StorageOpenHelper extends SQLiteOpenHelper {
	...
	public StorageOpenHelper(Context context, String name, CursorFactory factory, int version) {
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		Log.d(StorageConstants.DEBUG_TAG, "Database upgrading from " + Integer.toString(oldVersion) + " to " + Integer.toString(newVersion) + "...");
