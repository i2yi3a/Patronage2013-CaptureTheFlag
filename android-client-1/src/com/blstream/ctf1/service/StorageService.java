...
import static com.blstream.ctf1.service.StorageConstants.ID_LOGGED_PLAYER;
...
public class StorageService {
	...
	public void open() throws SQLiteException {
		mStorageOpenHelper = new StorageOpenHelper(mContext, StorageConstants.DB_NAME, null, StorageConstants.DB_VERSION);
	...
	public void saveLoggedPlayer(LoggedPlayer loggedPlayer) throws SQLException {
		...
		contentValues.put(StorageConstants.KEY_ID, ID_LOGGED_PLAYER);
	...
	public void deleteLoggedPlayer() {
		String where = StorageConstants.KEY_ID + "=" + ID_LOGGED_PLAYER;
	...
	public LoggedPlayer getLoggedPlayer() {
		...
		String[] columns = { StorageConstants.KEY_ID, StorageConstants.KEY_LOGIN, StorageConstants.KEY_ACCESS_TOKEN, StorageConstants.KEY_TOKEN_TYPE,
				StorageConstants.KEY_SCOPE };
		String where = StorageConstants.KEY_ID + "=" + ID_LOGGED_PLAYER;
		Cursor cursor = mDb.query(StorageConstants.DB_LOGGED_PLAYER_TABLE, columns, where, null, null, null, null);
